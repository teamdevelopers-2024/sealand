    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 items-stretch">
        ...
        <div className="bg-gray-800 p-6 rounded-lg flex flex-col justify-between">
          <h2 className="text-lg text-teal-400 mb-2">Today's Revenue</h2>
        ...
        {/* Card 2 */}
        <div className="bg-gray-800 p-6 rounded-lg flex flex-col justify-between">
          <h2 className="text-lg text-yellow-400 mb-2">Today's Expenses</h2>
        ...
        <div className="space-y-4">
          {/* Card 3 */}
          <div className="bg-gray-800 p-6 rounded-lg flex flex-col justify-between">
            <h2 className="text-lg text-teal-400 mb-2">Today's Customers</h2>
          ...
          {/* Card 4 */}
          <div className="bg-gray-800 p-6 rounded-lg flex flex-col justify-between">
            <h2 className="text-lg text-teal-400 mb-2">Yesterday's Revenue</h2>
